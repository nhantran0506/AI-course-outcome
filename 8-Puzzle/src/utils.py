...
class BoardNode(Node):
    def __init__(self, state, action=None, parent=None, depth=0):
        ...
        self.state = state
        self.action = action
        self.goal = tuple(range(6)) #(1, 2, 3, 4, 5, 6, 7, 8, 0)
