...
from Menu import *
from Play import GameController
import sys
...
class GameGUI:
    ...
    def draw_game_stats(self):
        if self.curr_menu.state != 'GA':  # path Ai algo
            instruction = '[Space] View path, [W] Speed up, [Q] Go back'
    ...
    def draw_banner(self):
        ...
        pygame.draw.rect(self.display, WINDOW_COLOR, banner)
    ...
    def draw_score(self):
        ...
        score_y = CELL_SIZE
        self.draw_text(score_text, 20, score_x, score_y, (255, 255, 255))
